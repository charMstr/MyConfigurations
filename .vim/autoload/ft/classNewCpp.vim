...
function! ft#classNewCpp#ClassNewCpp(ClassName)
	...
	:execute "normal! a//std::ostream\<tab>&\<cr>//operator<<(std::ostream &o, " . a:ClassName . " const &i)\<cr>//{\<cr>"
	...
	:execute "normal! a//std::ostream\<tab>&operator<<(std::ostream &o, " . a:ClassName . " const &i);"
